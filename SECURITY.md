...
If you discover a security vulnerability in L4 Kernel, please report it responsibly:
...
- Domain registry changes affect the whole workspace; require approval.
- MCP server exposes privileged operations; restrict access.
